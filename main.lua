...
worona.your_logo_icon		= "your_logo.png"		-- Name of the Custom Icon
worona.your_logo_width		= 250					-- Icon width
worona.your_logo_height    	= 100					-- Icon height
worona.your_logo_link		= "http://www.worona.org"  -- Icon link
